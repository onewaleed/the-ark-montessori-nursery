/**
 * The Ark Montessori Nursery - Footer Component Module
 * Injects unified branded footer with accreditation seal & contact information
 */
    ...
    <div class="container">
      <div class="footer-grid">
        <div class="footer-brand">
          ...
          <p class="footer-tagline">Authentic Montessori education for children aged 24 months to 5 years.</p>
        ...
        <div>
          ...
          <ul class="footer-links">
            ...
            <li><a href="parent-info.html#policies" class="footer-link">Policies</a></li>
            <li><a href="contact.html#careers" class="footer-link">Careers</a></li>
          </ul>
        </div>
        ...
        <div>
          <div class="accreditation-card">
            <div class="badge-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><path d="M12 6v6l4 2"/></svg></div>
            <div class="badge-text">Montessori<br>Accredited<br>Setting</div>
          </div>
        </div>
      </div>
